 ...
 *
 */
public abstract class ConcurrencyTestTmp {
  ...
  protected ThreadControl executeControllableCommand(final ControllableCommand<?> command, ProcessEngineConfigurationImpl processEngineConfiguration) {
  ...
  protected void deleteHistoryCleanupJobs(ProcessEngineConfigurationImpl processEngineConfiguration) {
    final List<Job> jobs = processEngineConfiguration.getHistoryService().findHistoryCleanupJobs();
